...
(function () {
  ...
  const GAS_URL = "https://script.google.com/macros/s/AKfycbwPXOJbEZ2L0FNWcytpejgSXh3UCcN8qGQWk8AgRPq384vY8Uf60LowDYMZimY-6owX/exec";
  ...
  "39917": { name: "นางสาว เยาวเรศ อภิวงค์", room: "ม.5/3" },
  ...
  "39958": { name: "นางสาว ธัญชนก คำพิกาศ", room: "ม.5/3" },
  "39965": { name: "นางสาว ณัฏธณิชา อินออม", room: "ม.5/3" },
  "39968": { name: "นางสาว ภัควลัญชณ์ กันทะวรรณ์", room: "ม.5/3" },
  "39973": { name: "นาย ปกรน์ ศรีบุญกอง", room: "ม.5/3" },
  "39998": { name: "นางสาว วิมลณัฐ วสุธวัช", room: "ม.5/3" },
  ...
  "40282": { name: "นาย ณัธุปกรณ์ ตุ่นไชย", room: "ม.5/3" },
  ...
  "42491": { name: "นางสาว สุลาลีวัลย์ กัณฑะ", room: "ม.5/3" },
  "42492": { name: "นางสาว ธิตินันท์ ไชยเขื่อน", room: "ม.5/3" },
  ...
  // ม.5/7
  // =========================
  "39858": { name: "นาย ชยพล แสนคะนารี", room: "ม.5/7" },
  "39881": { name: "นางสาว พรปวีณ์ ทรัพย์สนธิ", room: "ม.5/7" },
  "39893": { name: "นาย ภูริวัชร์ อุดมทิพย์", room: "ม.5/7" },
  "39901": { name: "นางสาว ศุจิกา ชูกลิ่น", room: "ม.5/7" },
  "39936": { name: "นาย สุกฤต สิงห์โตวะนา", room: "ม.5/7" },
  "39942": { name: "นาย พีรพัฒน์ สมบุนไชย", room: "ม.5/7" },
  "39943": { name: "นางสาว พิชญสิริ โกมาร", room: "ม.5/7" },
  ...
  "40005": { name: "นางสาว สุพิชญ์นันท์ กิติทรัพย์", room: "ม.5/7" },
  "40040": { name: "นางสาว กัลยรัตน์ กันทาทรัพย์", room: "ม.5/7" },
  "40042": { name: "นางสาว กนกนาถ สุปินนีะวรรณา", room: "ม.5/7" },
  "40045": { name: "นาย ณัฐภาส ศรีสด", room: "ม.5/7" },
  "40051": { name: "นาย ธนกฤติ พื้นอินต๊ะศรี", room: "ม.5/7" },
  "40244": { name: "นาย นาคพิชัย กาวิเนตร์", room: "ม.5/7" },
  "40246": { name: "นางสาว พิชชาภา บุญเฌอ", room: "ม.5/7" },
  "40249": { name: "นางสาว ขวัญวารินทร์ แก้วกันโท", room: "ม.5/7" },
  "40253": { name: "นางสาว ภคมน วงค์สถาน", room: "ม.5/7" },
  "40267": { name: "นาย ธราเทพ ไชยาส้าว", room: "ม.5/7" },
  "40277": { name: "นาย วรยุทธ์ ทิพยรักษ์", room: "ม.5/7" },
  "40327": { name: "นางสาว บุณยาพร เลิศวิไล", room: "ม.5/7" },
  "40352": { name: "นาย บุรพล สุธีรางกุร", room: "ม.5/7" },
  ...
  "42514": { name: "นางสาว มธุริน วิชัยกิตติกุล", room: "ม.5/7" },
  "42515": { name: "นาย ธีร์ธวัช หรัญบริรักษ์", room: "ม.5/7" },
  "42516": { name: "นางสาว ธฤบดี วงศ์อนันตชัย", room: "ม.5/7" },
  ...
  "42522": { name: "นางสาว รมิดา กตัญญคุณานนท์", room: "ม.5/7" },
  "42523": { name: "นาย นพวัฒน์ สุยะวาริ", room: "ม.5/7" },
  "42525": { name: "นางสาว เขมจิรา บุญมาอูป", room: "ม.5/7" },
  ...
  "39506": { name: "นาย เตโช ปานทอง", room: "ม.5/11" },
  "39979": { name: "นาย พิษณุ อุ่นละม้าย", room: "ม.5/11" },
  "39991": { name: "นาย กฤษฎา แก้ววิจิตร", room: "ม.5/11" },
  "39997": { name: "นางสาว มนต์ธิซา แก้วอยู่", room: "ม.5/11" },
  "40103": { name: "นาย ธฤติ แจ้ใจ", room: "ม.5/11" },
  ...
  "40346": { name: "นาย ธันกร ต๊ะกาบโพธิ์", room: "ม.5/11" },
  ...
  "42554": { name: "นาย ธณัท วิเศษกาศ", room: "ม.5/11" },
  "42555": { name: "นาย อนาวิน ปาสีล้อม", room: "ม.5/11" },
...
const sashQtyMinus = document.getElementById('sashQtyMinus');
const sashQtyPlus = document.getElementById('sashQtyPlus');
const sashQtyValue = document.getElementById('sashQtyValue');
const sashTotalPrice = document.getElementById('sashTotalPrice');
const sashPaymentTotal = document.getElementById('sashPaymentTotal');
...
function updateSashQuantity() {
  const total = sashQuantity * SASH_PRICE;
  if (sashQtyValue) sashQtyValue.textContent = sashQuantity;
  if (sashTotalPrice) sashTotalPrice.textContent = total;
  if (sashPaymentTotal) sashPaymentTotal.textContent = total;
}
...
if (sashQtyMinus) {
  sashQtyMinus.addEventListener('click', () => {
    if (sashQuantity > 1) {
      sashQuantity--;
      updateSashQuantity();
    }
...
if (sashQtyPlus) {
  sashQtyPlus.addEventListener('click', () => {
    if (sashQuantity < 20) {
      sashQuantity++;
      updateSashQuantity();
    }
...
if (sashLevelGrid) {
  sashLevelGrid.addEventListener('click', (e) => {
    ...
    // ล้าง selected เดิม
    sashLevelGrid.querySelectorAll('.pick-btn').forEach(b => {
      b.classList.remove('selected');
    });
...
if (sashRoomGrid) {
  sashRoomGrid.addEventListener('click', (e) => {
    ...
    sashRoomGrid.querySelectorAll('.pick-btn').forEach(b => {
      b.classList.remove('selected');
    });
...
if (sashSlipInput) {
  sashSlipInput.addEventListener('change', (e) => {
    ...
    reader.onload = function (ev) {
      ...
      const preview = document.getElementById('sashSlipPreview');
      if (preview) preview.src = sashSlipBase64;
      if (sashSlipPreviewBox) sashSlipPreviewBox.classList.add('show');
      if (sashUploadDrop) sashUploadDrop.classList.add('hidden');
      updateSashProgress();
    };
    reader.readAsDataURL(file);
  });
...
if (sashChangeSlipBtn) {
  sashChangeSlipBtn.addEventListener('click', () => {
    if (sashSlipInput) sashSlipInput.click();
  });
}
...
function updateSashProgress() {
  ...
  if (payComplete) {
    ...
    percent = 55;
    activeStep = 2;
  } else if (name || room || rollNo || contact) {
    percent = 25;
    activeStep = 1;
  }
  ...
  labels.forEach(l => {
    l.classList.toggle('active', Number(l.dataset.step) <= activeStep);
  });
}
...
if (sashForm) {
  ...
  sashForm.addEventListener('submit', async (e) => {
    ...
    const quantity = Number(sashQuantity);
    const totalPrice = quantity * SASH_PRICE;
    ...
    try {
      ...
      console.log('SASH RESPONSE:', data);
      ...
      if (data.success) {
        ...
        if (successBox) {
          successBox.innerHTML = `
            ...
            <p>🎗️ จำนวน: <strong>${quantity}</strong> ชิ้น</p>
            <p>💰 ยอดรวม: <strong>${totalPrice}</strong> บาท</p>
            <p style="font-size:14px;">⏳ กรุณารอการตรวจสอบการชำระเงิน</p>
          `;
      ...
      --------------------------------- */
        ...
        alert('❌ เกิดข้อผิดพลาดจากระบบ: ' + (data.error || 'ไม่ทราบสาเหตุ'));
      }
    } 
    /* ---------------------------------
       Connection Error
